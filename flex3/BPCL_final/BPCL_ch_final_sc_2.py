...
sc1=VideoStream('127.0.0.1',8098)
	...
	try:
		...
		while True:
			...
			if moving == True:
				...
				img1 = cv2.putText(img1, "Person in Position:"+str(Roi_draw) , (20,70), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 255, 204) , 2, cv2.LINE_AA)
				if number_view >= 1:
					img1 = cv2.putText(img1, "Person Attentiveness: True" , (20,110), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 255, 204) , 2, cv2.LINE_AA)
				else:
					img1 = cv2.putText(img1, "Person Attentiveness: False" , (20,110), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 255, 204) , 2, cv2.LINE_AA)
				if number_motion == 1:
					img1 = cv2.putText(img1, "Person Motion : True" , (20,150), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 255, 204) , 2, cv2.LINE_AA)
				else:
					img1 = cv2.putText(img1, "Person Motion : Flase" , (20,150), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 255, 204) , 2, cv2.LINE_AA)
			...
			img1 = cv2.putText(img1, "Flexi Test Bath 3 (Bath No.5)" , (600,70), cv2.FONT_HERSHEY_SIMPLEX , 1.4,  (255, 0, 0) , 2, cv2.LINE_AA)	
			sc1.screening(img1)
			#sc2.screening(img1)
