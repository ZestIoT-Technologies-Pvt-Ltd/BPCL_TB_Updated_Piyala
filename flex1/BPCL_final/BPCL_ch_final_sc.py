...
import XY_new_flexi1 as XY_track
...
sc1=VideoStream('127.0.0.1',8096)
		...
		while True:
			...
			if moving == True:
				if idle_time != 0:
					...
					idle_time = 0
				input_image, draw_image, output_scale = posenet.read_imgfile(img1, scale_factor=0.725, output_stride=output_stride)
				...
				if number_roi >= 1 and number_view >=  1 and number_motion == 0:
					...
					Motion_draw = False
				img1 = cv2.putText(img1, "Person in Position:"+str(Roi_draw) , (20,70), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 0, 0) , 2, cv2.LINE_AA)
				if number_view >= 1:
					img1 = cv2.putText(img1, "Person Attentiveness: True" , (20,110), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 0, 0) , 2, cv2.LINE_AA)
				else:
					img1 = cv2.putText(img1, "Person Attentiveness: False" , (20,110), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 0, 0) , 2, cv2.LINE_AA)
				if number_motion == 1:
					img1 = cv2.putText(img1, "Person Motion : True" , (20,150), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 0, 0) , 2, cv2.LINE_AA)
				else:
					img1 = cv2.putText(img1, "Person Motion : Flase" , (20,150), cv2.FONT_HERSHEY_SIMPLEX , 1,  (255, 0, 0) , 2, cv2.LINE_AA)
			...
			img1 = cv2.putText(img1, "Flexi Test Bath 1 (Bath No. 3)" , (600,70), cv2.FONT_HERSHEY_SIMPLEX , 1.4,  (255, 0, 0) , 2, cv2.LINE_AA)
			sc1.screening(img1)
			#sc2.screening(img1)
