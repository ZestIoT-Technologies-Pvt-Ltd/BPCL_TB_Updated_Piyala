...
def view_detection(view_coords,view_scores,roi):
    ...
    for person in range(0,roi):
        ...
        #if (right_eye_y > right_ear_y) and (left_eye_y < left_ear_y) and (nose_x+35 > left_shoulder_x and nose_x+35 > right_shoulder_x)  and (left_ear_score > 0.04 and right_ear_score > 0.04):
        if (nose_x+30 > left_shoulder_x and nose_x+30 > right_shoulder_x) and (right_eye_y > right_ear_y) and (left_eye_y < left_ear_y) and (left_ear_score > 0.05 and right_ear_score > 0.05):
        #if (nose_x+32 > left_shoulder_x and nose_x+32 > right_shoulder_x) and (nose_y < left_eye_y) and (nose_y > right_eye_y):
                #if nose_x+60 > left_shoulder_x and nose_x+60 > right_shoulder_x :
            motion_coords.append(view_coords[person])
            motion_scores.append(view_scores[person])
            #Viw_per[person]=1
