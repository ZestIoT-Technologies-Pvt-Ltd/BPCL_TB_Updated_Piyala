...
import error
import subprocess
error_file="/home/zestiot/BPCL_3/BPCL_final/error_code.txt"
last_event="/home/zestiot/BPCL_3/BPCL_final/last_event.txt"
def health():
    try:
...
def net_event(sc):
    try:
        ...
        with open("/home/zestiot/BPCL_3/BPCL_final/net_event.txt","r+") as f:
            for i in f.readlines():
                ...
                msg = sc.receive()
                print(msg)'''
                subprocess.call(["sed -i 1d /home/zestiot/BPCL_3/BPCL_final/net_event.txt"],shell=True)
    except Exception as e:
