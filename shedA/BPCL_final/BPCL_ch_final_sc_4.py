...
sc1=VideoStream('127.0.0.1',8100)
	...
	try:
		...
		while True:
			...
			if moving == True:
				...
				img1 = cv2.putText(img1, "Shed A Test Bath" , (620,70), cv2.FONT_HERSHEY_SIMPLEX , 1.5,  (255, 0, 0) , 2, cv2.LINE_AA)
			...
			img1 = cv2.putText(img1, "Shed A Test Bath (Bath No.1)" , (600,70), cv2.FONT_HERSHEY_SIMPLEX , 1.4,  (255, 0, 0) , 2, cv2.LINE_AA)
			sc1.screening(img1)
			#sc2.screening(img1)
